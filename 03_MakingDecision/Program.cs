...
namespace _03_MakingDecision
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //if (city == "antalya" | city == "ankara" | city == "bursa" | city == "adana") 
            //{
            ...
            //Console.Write("Kullanıcı adın giriniz: ");
            ...
            //Console.WriteLine("*****CSharp Eğitim Kampi Restoran *****");
            //Console.WriteLine();
            //Console.WriteLine("-------------------------------");
            ...
            //string menuItem;
            //Console.WriteLine();
            //Console.Write("Detayını Görmek İstediğiniz Menü: ");
